...
/*   Updated: 2024/03/27 16:50:35 by yrio             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Test 8 : ./minishell "export HOLA=bonjour | cat supp.supp"
	t_tree		*tree;
	t_lstcmd	*cmd1;
	t_lstcmd	*cmd2;
...
Test 9 :
cmd : echo test | cat supp.supp && cat supp.supp && cat supp.supp | grep i | grep o && echo ok
*/
